...
const Contactlinks = ({ items, className }) => {
    ...
    return (
        ...
        <>
        <div className="absolute top-10 text-5xl text-blue-100">Contact Me</div>
            <div className={`flex gap-[5em] mx-auto py-[3em] overflow-visible ${className || ""}`}>
                {items.map((item, index) => (
                    <a
                        ...
                        className="relative bg-transparent outline-none w-[10em] h-[4.5em] [perspective:24em] [transform-style:preserve-3d] [-webkit-tap-highlight-color:transparent] group"
                    >
                        {/* Back layer */}
                        <span
