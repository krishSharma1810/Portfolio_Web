  ...
  return (
    <div className={cn("text-base sm:text-xl md:text-3xl lg:text-5xl font-bold text-center", className)}>
      ...
      <motion.span
        ...
        className={cn(
          "inline-block rounded-sm w-[3px] sm:w-[4px] h-3 sm:h-4 md:h-6 lg:h-10 bg-blue-500",
          cursorClassName,
        )}
      ></motion.span>
    </div>
...
const TypewriterEffectSmooth = ({ words, className, cursorClassName }) => {
  ...
  return (
    <div className={cn("flex justify-center space-x-1 my-4 sm:my-6", className)}>
      <motion.div
      ...
      <motion.span
        ...
        className={cn("block rounded-sm w-[3px] sm:w-[4px] h-3 sm:h-4 md:h-6 xl:h-12 bg-blue-500", cursorClassName)}
      ></motion.span>
    </div>
  )
}
