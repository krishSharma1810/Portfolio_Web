...
const Timeline = ({ data = [] }) => { 
  ...
  return (
    <div className="w-full h-auto sm:h-[180vh] bg-white dark:bg-transparent font-sans px-4 md:px-10" ref={containerRef}>
      <div className="max-w-7xl mx-auto py-10 sm:py-20 px-2 sm:px-4 md:px-8 lg:px-10">
        <h2 className="text-xl sm:text-2xl md:text-4xl lg:text-6xl text-black dark:text-white max-w-4xl">
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-10 sm:pb-20">
        ...
        <div
          ...
          className="absolute md:left-8 left-4 sm:left-8 top-0 overflow-hidden w-[2px] bg-[linear-gradient(to_bottom,var(--tw-gradient-stops))] from-transparent from-[0%] via-neutral-200 dark:via-neutral-700 to-transparent to-[99%]  [mask-image:linear-gradient(to_bottom,transparent_0%,black_10%,black_90%,transparent_100%)] "
        >
          <motion.div
            style={{
