...
export const CardContainer = ({ children, className, containerClassName }) => {
  ...
  return (
    <MouseEnterContext.Provider value={[isMouseEntered, setIsMouseEntered]}>
      <div
        className={cn("py-4 sm:py-8 flex items-center justify-center", containerClassName)}
...
export const CardBody = ({ children, className }) => {
  return (
    <div
      className={cn(
        "h-auto w-full sm:w-80 md:w-96 [transform-style:preserve-3d] [&>*]:[transform-style:preserve-3d] overflow-hidden",
        className,
      )}
    >
      {children}
